...
export default function Trash() {
  ...
  const fetchData = async () => {
    try {
      ...
      //     customers/onlycustomer?${HelperFunction.convertToQueryString(queryData)},
      //   ).getRequest()
  ...
  //           // <img
  //           //   src={${URL}/${row?.featured_image_details?.filepath}}
  //           //   alt="Featured_image"
  ...
  return (
    <>
      ...
      <CContainer fluid>
        {/* {rowPerPage && data && ( */}
        {isLoading ? (
          <div className="custom-table-shimmer">{/* <ShimmerTable row={10} /> */}</div>
        ) : (
